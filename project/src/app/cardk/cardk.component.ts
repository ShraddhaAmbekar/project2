...
@Component({
  selector: 'app-cardk',
  templateUrl: './cardk.component.html',
  styleUrls: ['./cardk.component.css']
})
export class CardkComponent {
  ...
  addEmployee() {
    let employee: Employee = {
      ...
      hotelMenu: '',
      roomsAvailable: 0,
      birthdate: function (birthdate: any): void {
